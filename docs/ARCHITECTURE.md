...
Auto-extracted dynamically from **73 Production UI Components** using Babel AST:
...
| **`BookshelfRack`** | Presentation | `BookshelfRackProps` | `books`, `onBookClick`, `onDownloadClick`, `onBrowseCatalog`, `searchQuery`, `onClearSearch`, `showShelfControls` | [`src/components/presentation/BookshelfRack.tsx`](src/components/presentation/BookshelfRack.tsx) |
...
Pure business logic, historical engines, and layout algorithms verified across **33 Domain Modules** using Babel AST:
