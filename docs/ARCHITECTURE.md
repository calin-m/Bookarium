...
> **Topology Health**: `109` Modules Analyzed • `294` Static Linkages • `0` Circular Dependencies • `0` Orphaned Modules
...
| [`Navbar.tsx`](src/components/presentation/Navbar.tsx) | `stores/useBookshelfStore`, `stores/useThemeStore`, `stores/useAuthStore`, `components/ui/Button`, `config/routes`, `config/site-config` | `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx` | Production Module |
...
| [`site-config.ts`](src/config/site-config.ts) | _Root Primitive_ | `route.ts`, `route.ts`, `layout.tsx`, `page.tsx`, `Footer.tsx`, `Navbar.tsx`, `GutenbergInfoModal.tsx`, `useBookshelfStore.ts`, `usePreferencesStore.ts`, `useReaderStore.ts`, `useThemeStore.ts` | Production Module |
