...
> **Topology Health**: `30` Modules Analyzed • `57` Static Linkages • `0` Circular Dependencies • `0` Orphaned Modules
...
| [`page.tsx`](src/app/page.tsx) | `components/presentation/Navbar`, `components/presentation/HeroSearch`, `components/presentation/StickyCatalogToolbar`, `components/presentation/AdvancedFilterDrawer`, `components/presentation/BookGrid`, `components/presentation/EditorialArticles`, `components/presentation/BookReaderModal`, `components/presentation/DownloadDrawer`, `components/presentation/Footer`, `hooks/queries/useBooks`, `stores/useBookshelfStore`, `stores/useReaderStore`, `mocks/handlers`, `components/ui/Button` | _App Route Entry_ | Production Module |
...
| [`EditorialArticles.tsx`](src/components/presentation/EditorialArticles.tsx) | _Root Primitive_ | `page.tsx` | Production Module |
...
| [`useBookContent.ts`](src/hooks/queries/useBookContent.ts) | `mocks/handlers` | `BookReaderModal.tsx` | Production Module |
| [`useBooks.ts`](src/hooks/queries/useBooks.ts) | `mocks/handlers` | `page.tsx` | Production Module |
...
| [`utils.ts`](src/lib/utils.ts) | _Root Primitive_ | `BookCard.tsx`, `BookReaderModal.tsx`, `DownloadDrawer.tsx`, `Badge.tsx`, `Button.tsx`, `Card.tsx`, `Input.tsx`, `Modal.tsx` | Production Module |
| [`useBookshelfStore.ts`](src/stores/useBookshelfStore.ts) | `mocks/handlers` | `page.tsx`, `BookCard.tsx`, `BookReaderModal.tsx`, `BookshelfRack.tsx`, `Navbar.tsx` | Production Module |
| [`useReaderStore.ts`](src/stores/useReaderStore.ts) | `mocks/handlers` | `page.tsx`, `BookCard.tsx`, `BookReaderModal.tsx`, `BookshelfRack.tsx` | Production Module |
