...
export const READER_THEMES: Record<ReaderTheme, ReaderThemeConfig> = {
  ...
  sepia: {
    ...
    header: 'bg-[#332219] text-[#fef6eb] border-[#5a3928] shadow-xs',
    footer: 'bg-[#332219] text-[#fef6eb] border-[#5a3928] shadow-xs',
    pill: 'bg-[#402a1d] border-[#5a3928] text-[#e8d2be]',
    activePill: 'bg-[#f59e0b] text-[#2b1d16] shadow-xs font-bold',
    inactivePill: 'text-[#cbb39d] hover:text-[#fef6eb]',
    button: 'bg-[#402a1d] border-[#5a3928] text-[#e8d2be] hover:text-[#f59e0b] hover:border-[#f59e0b]',
    border: 'border-[#5a3928]',
    textMuted: 'text-[#cbb39d]',
    drawerBg: 'bg-[#332219] border-[#5a3928] text-[#fef6eb]',
