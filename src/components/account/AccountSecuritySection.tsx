  ...
  return (
    <div className="bg-card border border-border rounded-2xl p-6 sm:p-7 shadow-booksaw space-y-6">
      ...
      <div className="border-t border-border pt-6">
        <div className="rounded-xl border border-destructive/40 dark:border-destructive/50 bg-destructive/5 p-4 sm:p-5 space-y-3">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <Button
              ...
              className="border-destructive/50 dark:border-destructive/60 text-destructive hover:bg-destructive/10 shrink-0 font-mono text-xs"
