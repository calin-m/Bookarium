  ...
  return (
    <div className="bg-card border border-border rounded-2xl p-6 sm:p-7 shadow-booksaw space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        {/* Left Column (6 cols): Atmosphere, Sticky Navigation, and Backups */}
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="border-t border-border pt-4 space-y-4" data-testid="library-portability-section">
        ...
        {/* Right Column (6 cols): Audio Narration & Web Speech Sanctuary */}
        <div className="lg:col-span-6 space-y-4 lg:border-l lg:border-border lg:pl-8">
          ...
          <div className="pt-2 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-t border-border/60">
            <button
              ...
              className={`px-4 py-2.5 rounded-xl border text-xs font-mono font-bold flex items-center justify-center gap-2 transition-all cursor-pointer shadow-xs active:scale-95 ${
                isPreviewPlaying
