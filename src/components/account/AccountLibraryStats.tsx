...
import { Bookmark, Heart, BookOpen, ArrowUpRight } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5">
        ...
        >
          ...
          <div className="flex items-end justify-between">
            <p className="text-2xl font-mono font-bold text-foreground leading-none">{savedCount}</p>
        ...
        >
          ...
          <div className="flex items-end justify-between">
            <p className="text-2xl font-mono font-bold text-foreground leading-none">{likedCount}</p>
            <ArrowUpRight className="w-4 h-4 text-primary opacity-0 group-hover:opacity-100 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-150 shrink-0" />
          </div>
        </Link>
        ...
        >
          ...
          <div className="flex items-end justify-between">
            <p data-testid="custom-shelves-count" className="text-2xl font-mono font-bold text-foreground leading-none">{customShelvesCount}</p>
            <ArrowUpRight className="w-4 h-4 text-primary opacity-0 group-hover:opacity-100 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-150 shrink-0" />
          </div>
        </Link>
      </div>
