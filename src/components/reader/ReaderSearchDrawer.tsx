      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed top-[6.25rem] sm:top-20 inset-x-3 sm:inset-x-auto sm:right-6 w-auto max-w-sm sm:w-96 mx-auto sm:mx-0 z-[9999] max-h-[calc(100dvh-7rem)] rounded-xl ${activeTheme.drawerBg} border ${activeTheme.border} shadow-2xl p-4 sm:p-4.5 flex flex-col origin-top sm:origin-top-right`}
            role="dialog"
            aria-modal="true"
