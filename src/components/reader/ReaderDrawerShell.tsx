      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={cn(
              'fixed top-[5.875rem] inset-x-3 sm:inset-x-auto sm:right-6 md:right-8 w-auto max-w-sm sm:w-96 mx-auto sm:mx-0 z-[9999] max-h-[calc(100dvh-11.5rem)] rounded-xl border shadow-2xl p-4 sm:p-4.5 flex flex-col min-h-0 overflow-hidden origin-top sm:origin-top-right',
