      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={`fixed top-[6.75rem] sm:top-[7.25rem] inset-x-3 sm:inset-x-auto sm:right-6 md:right-8 w-auto max-w-sm sm:w-80 mx-auto sm:mx-0 z-[9999] max-h-[calc(100dvh-8.5rem)] rounded-xl ${activeTheme.drawerBg} border ${activeTheme.border} shadow-2xl p-4 sm:p-4.5 flex flex-col origin-top sm:origin-top-right`}
            role="dialog"
            aria-modal="true"
